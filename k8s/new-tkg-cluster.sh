...
kubectl vsphere login --server $SC_IP --vsphere-username administrator@vsphere.local --tanzu-kubernetes-cluster-namespace $NAMESPACE --tanzu-kubernetes-cluster-name tkc-1
